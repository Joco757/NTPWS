...
<body>
	...
	if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
		...
		if (!empty($_COOKIE['news_title_1'])) {
			print '
			<div class="news">
				<h3>' . $_COOKIE['news_title_1'] . '</h3>
				<time datetime="2017-10-25">' . $_COOKIE['news_date_1'] . '</time>
				<p><a href="index.php?menu=2&action=1">Pročitaj više...</a></p>
			</div>';
		}
		if (!empty($_COOKIE['news_title_2'])) {
			print '
			<div class="news">
				<h3>' . $_COOKIE['news_title_2'] . '</h3>
				<time datetime="2017-10-26">' . $_COOKIE['news_date_2'] . '</time>
				<p><a href="index.php?menu=2&action=2">Pročitaj više...</a></p>
			</div>';
		}
		if (!empty($_COOKIE['news_title_3'])) {
			print '
			<div class="news">
				<h3>' . $_COOKIE['news_title_3'] . '</h3>
				<time datetime="2017-10-27">' . $_COOKIE['news_date_3'] . '</time>
				<p><a href="index.php?menu=2&action=3">Pročitaj više...</a></p>
			</div>';
		}
		print '
		</aside>';
